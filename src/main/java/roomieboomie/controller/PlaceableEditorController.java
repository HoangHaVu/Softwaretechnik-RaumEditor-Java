...
public class PlaceableEditorController {
    ...
    public PlaceableEditorController(RoomEditor roomEditor){
        ...
        File file = new File("C:\\Users\\HongiiBongii\\Uni\\4.Semester\\Softwaretechnik\\RoomieBoomie - Bilder\\dino.png");
        Image image1 = new Image(file.toURI().toString());
        tisch.setImage(image1);
        items.add(tisch);
    ...
    private void initialize(){
        ...
        listview.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> {
            roomEditor.selectnewPlaceableItem(PlacableItemType.TABLE);
            delete.setStyle("");
            edit.setStyle("");
            this.action = Action.PLACE;
            refreshPreview();
    ...
    public void initInteractionPane(){
        ...
        itemPane.setStyle("-fx-background-color: #803d2e;");
